...
summary_path = "C:\\Users\\Akshita\\Desktop\\project\\output_data\\rag_summary.txt"
...
pipeline_path = "C:\\Users\\Akshita\\Desktop\\project\\agents\\explainability_agent\\final_pipeline.pkl"
...
def prettify_feature(name):
    ...
    name = re.sub(r"\b(\w)", lambda m: m.group(1).upper(), name)  # capitalize each word
...
if assistant_reply:
    ...
    print("  No response from Foundry agent.")